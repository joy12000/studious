...
class handler(BaseHTTPRequestHandler):
    def do_POST(self):
        ...
        try:
            ...
            3. 알고리즘, 프로세스, 복잡한 개념 등 시각적 설명이 필요할 경우, Mermaid.js 문법을 사용하여 다이어그램을 그려주세요.
            4. 답변이 끝난 후, 사용자가 더 깊이 탐색해볼 만한 흥미로운 후속 질문 3개를 한국어로 제안해주세요.
            5. 최종 결과는 반드시 {"answer": "...", "followUp": ["...", "...", "..."]} 형식의 JSON 객체로만 응답해야 합니다. 다른 말은 절대 추가하지 마세요.
            """
